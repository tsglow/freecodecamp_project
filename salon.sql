...
INSERT INTO public.appointments VALUES (2, 31, '555-555-5555', '10:30', 1);
INSERT INTO public.appointments VALUES (4, 31, '555-555-5555', '11am', 2);
...
--
-- Name: appointments fkservice_id; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT fkservice_id FOREIGN KEY (service_id) REFERENCES public.services(service_id);
